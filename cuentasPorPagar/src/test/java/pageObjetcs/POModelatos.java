...
public class POModelatos {
    ...
    //constructor
	public POModelatos(WebDriver driver) {
	...
	public void AbrirPagina() {
	 Navegador.abrirPagina(excel.getURLModelatos());
	...
	public void ingresarUsuarioSuper(){
		auth_username.sendKeys(excel.getUser());
	
	}
	
	public void IngresarcontraseñaSuper(){
			
		 this.auth_password.sendKeys(excel.getPassModelatos());
	}
